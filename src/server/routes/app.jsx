...
export const appRoute = async (fastify) => {
  ...
  fastify.get("/races/:raceId/*", async (req, res) => {
    ...
    if (req.url.toString().match(/.+odds$/)) {
      ...
      res.raw.setHeader("Link", `</assets/js/main.bundle.js>; rel=preload; as=script, <${imageURL}>; rel=preload; as=image, </assets/fonts/MODI_Senobi-Gothic_2017_0702/Senobi-Gothic-Bold.woff>; rel=preload; as=font; crossorigin, </assets/js/odds.bundle.js>; rel=preload; as=script; crossorigin`)
    } else {
