...
const SVG = () => <svg aria-hidden="true" className="svg-inline--fa fa-info-circle fa-w-16" data-fa-i2svg="" data-icon="info-circle" data-prefix="fas" focusable="false" role="img" style={{
...
export const Odds = React.memo(({ serverData }) => {
  ...
  let { data: fetchData } = useFetch(`/api/races/${raceId}`)
